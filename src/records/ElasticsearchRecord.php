...
class ElasticsearchRecord extends ActiveRecord
{
    ...
    private $_schema;
    private $_attributes = ['title', 'summary', 'text', 'slug', 'uri', 'postDate', 'category', 'categoryNames', 'sectionName' 'tags', 'sectionSlug', 'sectionId', 'authorId', 'author', 'username', 'section', 'content', 'result'];
    private $_element;
